  ...
  return (
    <section id="proyectos" className="py-12 relative">
      <div className="container max-w-4xl mx-auto px-6 md:px-4">
        ...
        {/* 🔹 Grid de 1 columna para mostrar proyectos uno debajo del otro */}
            ...
            <MotionWrapper key={project.title} delay={index * 0.2}>
              <GlassCard className="group overflow-hidden dark:border-purple-500/10 h-full flex flex-col">
                ...
                <CardContent className="flex-grow">
                  <ul className="list-disc ml-4 space-y-2 text-sm group-hover:space-y-3 transition-all duration-300">
